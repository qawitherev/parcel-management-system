...
{
    public class ResidentUnitRepository : BaseRepository<ResidentUnit>, IResidentUnitRepository
    {
        ...
        public async Task<int> GetResidentUnitCountBySpecification(ISpecification<ResidentUnit> specification)
        {
